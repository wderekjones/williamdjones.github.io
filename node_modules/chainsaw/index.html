...
<title>Chainsaw | derek jones</title>
<meta name="generator" content="Jekyll v3.8.5" />
<meta property="og:title" content="Chainsaw" />
<meta name="author" content="Derek Jones" />
<meta property="og:locale" content="en" />
<link rel="canonical" href="http://localhost:4000/node_modules/chainsaw/" />
<meta property="og:url" content="http://localhost:4000/node_modules/chainsaw/" />
...
{"@type":"WebPage","author":{"@type":"Person","name":"Derek Jones"},"headline":"Chainsaw","url":"http://localhost:4000/node_modules/chainsaw/","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/chainsaw/" hreflang="en">
...
>
  ...
  <header>
    <h1 class="page-title">Chainsaw</h1>
...
<p>Just call <code class="highlighter-rouge">Chainsaw</code> with a constructor function like in the examples below.
In your methods, just do <code class="highlighter-rouge">saw.next()</code> to move along to the next event and
<code class="highlighter-rouge">saw.nest()</code> to create a nested chain.</p>

<h1 id="examples">Examples</h1>

<h2 id="add_dojs">add_do.js</h2>

<p>This silly example adds values with a chainsaw.</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>var Chainsaw = require('chainsaw');
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>git clone http://github.com/substack/node-chainsaw.git
</code></pre></div></div>

<p>To run the tests with <a href="http://github.com/visionmedia/expresso">expresso</a>,
just do:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>expresso
</code></pre></div></div>

<h1 id="light-mode-vs-full-mode">Light Mode vs Full Mode</h1>

<p><code class="highlighter-rouge">node-chainsaw</code> supports two different modes. In full mode, every
action is recorded, which allows you to replay actions using the
<code class="highlighter-rouge">jump()</code>, <code class="highlighter-rouge">trap()</code> and <code class="highlighter-rouge">down()</code> methods.</p>
...
<p>To enable light mode simply use <code class="highlighter-rouge">Chainsaw.light()</code> to construct your
saw, instead of <code class="highlighter-rouge">Chainsaw()</code>.</p>
