...
{"@type":"WebPage","author":{"@type":"Person","name":"Derek Jones"},"headline":"derek jones","url":"http://localhost:4000/node_modules/express/","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/express/" hreflang="en">
...
>
  ...
  <p><a href="http://expressjs.com/">
  <hy-img root-margin="512px"  src="https://i.cloudup.com/zfY6lL7eFa-3000x3000.png" alt="Express Logo" >
    <noscript><img data-ignore  src="https://i.cloudup.com/zfY6lL7eFa-3000x3000.png" alt="Express Logo" /></noscript>
...
<p><a href="https://npmjs.org/package/express">
  <hy-img root-margin="512px"  src="https://img.shields.io/npm/v/express.svg" alt="NPM Version" >
    <noscript><img data-ignore  src="https://img.shields.io/npm/v/express.svg" alt="NPM Version" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></a>
  <a href="https://npmjs.org/package/express">
  <hy-img root-margin="512px"  src="https://img.shields.io/npm/dm/express.svg" alt="NPM Downloads" >
    <noscript><img data-ignore  src="https://img.shields.io/npm/dm/express.svg" alt="NPM Downloads" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></a>
  <a href="https://travis-ci.org/expressjs/express">
  <hy-img root-margin="512px"  src="https://img.shields.io/travis/expressjs/express/master.svg?label=linux" alt="Linux Build" >
    <noscript><img data-ignore  src="https://img.shields.io/travis/expressjs/express/master.svg?label=linux" alt="Linux Build" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></a>
  <a href="https://ci.appveyor.com/project/dougwilson/express">
  <hy-img root-margin="512px"  src="https://img.shields.io/appveyor/ci/dougwilson/express/master.svg?label=windows" alt="Windows Build" >
    <noscript><img data-ignore  src="https://img.shields.io/appveyor/ci/dougwilson/express/master.svg?label=windows" alt="Windows Build" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></a>
  <a href="https://coveralls.io/r/expressjs/express?branch=master">
  <hy-img root-margin="512px"  src="https://img.shields.io/coveralls/expressjs/express/master.svg" alt="Test Coverage" >
    <noscript><img data-ignore  src="https://img.shields.io/coveralls/expressjs/express/master.svg" alt="Test Coverage" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></a></p>
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm <span class="nb">install </span>express
</code></pre></div></div>
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm <span class="nb">install</span> <span class="nt">-g</span> express-generator@4
</code></pre></div></div>
