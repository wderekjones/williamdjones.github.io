...
<title>browserify | derek jones</title>
<meta name="generator" content="Jekyll v3.8.5" />
<meta property="og:title" content="browserify" />
<meta name="author" content="Derek Jones" />
<meta property="og:locale" content="en" />
<link rel="canonical" href="http://localhost:4000/node_modules/browserify/" />
<meta property="og:url" content="http://localhost:4000/node_modules/browserify/" />
...
{"@type":"WebPage","author":{"@type":"Person","name":"Derek Jones"},"headline":"browserify","url":"http://localhost:4000/node_modules/browserify/","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/browserify/" hreflang="en">
...
<p><code class="highlighter-rouge">require('modules')</code> in the browser</p>

<p>Use a <a href="http://nodejs.org">node</a>-style <code class="highlighter-rouge">require()</code> to organize your browser code
and load modules installed by <a href="https://www.npmjs.com">npm</a>.</p>

<p>browserify will recursively analyze all the <code class="highlighter-rouge">require()</code> calls in your app in
order to build a bundle you can serve up to the browser in a single <code class="highlighter-rouge">&lt;script&gt;</code>
tag.</p>

<p><a href="http://travis-ci.org/substack/node-browserify">
  <hy-img root-margin="512px"  src="https://secure.travis-ci.org/substack/node-browserify.png" alt="build status" >
    <noscript><img data-ignore  src="https://secure.travis-ci.org/substack/node-browserify.png" alt="build status" /></noscript>
...
<p>
  <hy-img root-margin="512px"  src="http://substack.net/images/browserify_logo.png" alt="browserify!" >
    <noscript><img data-ignore  src="http://substack.net/images/browserify_logo.png" alt="browserify!" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></p>
...
<p>If you’re new to browserify, check out the
...
<p>Whip up a file, <code class="highlighter-rouge">main.js</code> with some <code class="highlighter-rouge">require()</code>s in it. You can use relative
paths like <code class="highlighter-rouge">'./foo.js'</code> and <code class="highlighter-rouge">'../lib/bar.js'</code> or module paths like <code class="highlighter-rouge">'gamma'</code>
that will search <code class="highlighter-rouge">node_modules/</code> using
<a href="https://github.com/substack/node-resolve">node’s module lookup algorithm</a>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">foo</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'./foo.js'</span><span class="p">);</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">n</span><span class="p">)</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">n</span> <span class="o">*</span> <span class="mi">111</span> <span class="p">}</span>
</code></pre></div></div>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify main.js &gt; bundle.js
</code></pre></div></div>

<p>All of the modules that <code class="highlighter-rouge">main.js</code> needs are included in the <code class="highlighter-rouge">bundle.js</code> from a
recursive walk of the <code class="highlighter-rouge">require()</code> graph using
<a href="https://github.com/defunctzombie/node-required">required</a>.</p>

<p>To use this bundle, just toss a <code class="highlighter-rouge">&lt;script src="bundle.js"&gt;&lt;/script&gt;</code> into your
html!</p>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Usage: browserify [entry files] {OPTIONS}
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Advanced Options:
...
<p>Many <a href="http://npmjs.org">npm</a> modules that don’t do IO will just work after being
...
<p>You can just as easily create a bundle that will export a <code class="highlighter-rouge">require()</code> function so
you can <code class="highlighter-rouge">require()</code> modules from another script tag. Here we’ll create a
<code class="highlighter-rouge">bundle.js</code> with the <a href="https://www.npmjs.com/package/through">through</a>
and <a href="https://www.npmjs.com/package/duplexer">duplexer</a> modules.</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify -r through -r duplexer -r ./my-file.js:my-module &gt; bundle.js
</code></pre></div></div>
...
<p>If you prefer the source maps be saved to a separate <code class="highlighter-rouge">.js.map</code> source map file, you may use
<a href="https://github.com/thlorenz/exorcist">exorcist</a> in order to achieve that. It’s as simple as:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify main.js --debug | exorcist bundle.js.map &gt; bundle.js
</code></pre></div></div>
...
<p>If browserify finds a <code class="highlighter-rouge">require</code>d function already defined in the page scope, it
...
still being able to use <code class="highlighter-rouge">require()</code>. Just use a combination of <code class="highlighter-rouge">--external</code> and
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">robot</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'./robot.js'</span><span class="p">);</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">s</span><span class="p">)</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">s</span><span class="p">.</span><span class="nx">toUpperCase</span><span class="p">()</span> <span class="o">+</span> <span class="s1">'!'</span> <span class="p">};</span>
</code></pre></div></div>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify -r ./robot.js &gt; static/common.js
...
<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"common.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
...
<p>This approach using <code class="highlighter-rouge">-r</code> and <code class="highlighter-rouge">-x</code> works fine for a small number of split assets,
...
<p><code class="highlighter-rouge">files</code> and <code class="highlighter-rouge">opts</code> are both optional, but must be in the order shown if both are
passed.</p>
...
<code class="highlighter-rouge">opts.basedir</code> when using streaming files so that relative requires can be
resolved.</p>

<p><code class="highlighter-rouge">opts.entries</code> has the same definition as <code class="highlighter-rouge">files</code>.</p>

<p><code class="highlighter-rouge">opts.noParse</code> is an array which will skip all require() and global parsing for
...
<p><code class="highlighter-rouge">opts.extensions</code> is an array of optional extra extensions for the module lookup
...
<p><code class="highlighter-rouge">opts.basedir</code> is the directory that browserify starts bundling from for
filenames that start with <code class="highlighter-rouge">.</code>.</p>

<p><code class="highlighter-rouge">opts.paths</code> is an array of directories that browserify searches when looking
for modules which are not referenced using relative path. Can be absolute or
relative to <code class="highlighter-rouge">basedir</code>. Equivalent of setting <code class="highlighter-rouge">NODE_PATH</code> environmental variable
when calling <code class="highlighter-rouge">browserify</code> command.</p>

<p><code class="highlighter-rouge">opts.commondir</code> sets the algorithm used to parse out the common paths. Use
<code class="highlighter-rouge">false</code> to turn this off, otherwise it uses the
<a href="https://www.npmjs.com/package/commondir">commondir</a> module.</p>

<p><code class="highlighter-rouge">opts.fullPaths</code> disables converting module ids into numerical indexes. This is
useful for preserving the original paths that a bundle was generated with.</p>

<p><code class="highlighter-rouge">opts.builtins</code> sets the list of built-ins to use, which by default is set in
<code class="highlighter-rouge">lib/builtins.js</code> in this distribution.</p>

<p><code class="highlighter-rouge">opts.bundleExternal</code> boolean option to set if external modules should be
bundled. Defaults to true.</p>

<p>When <code class="highlighter-rouge">opts.insertGlobals</code> is true, always insert <code class="highlighter-rouge">process</code>, <code class="highlighter-rouge">global</code>,
<code class="highlighter-rouge">__filename</code>, and <code class="highlighter-rouge">__dirname</code> without analyzing the AST for faster builds but
larger output bundles. Default false.</p>

<p>When <code class="highlighter-rouge">opts.detectGlobals</code> is true, scan all files for <code class="highlighter-rouge">process</code>, <code class="highlighter-rouge">global</code>,
<code class="highlighter-rouge">__filename</code>, and <code class="highlighter-rouge">__dirname</code>, defining as necessary. With this option npm
modules are more likely to work but bundling takes longer. Default true.</p>

<p>When <code class="highlighter-rouge">opts.debug</code> is true, add a source map inline to the end of the bundle.
This makes debugging easier because you can see all the original files if
you are in a modern enough browser.</p>

<p>When <code class="highlighter-rouge">opts.standalone</code> is a non-empty string, a standalone module is created
with that name and a <a href="https://github.com/forbeslindesay/umd">umd</a> wrapper.
You can use namespaces in the standalone global export using a <code class="highlighter-rouge">.</code> in the string
name as a separator, for example <code class="highlighter-rouge">'A.B.C'</code>. The global export will be <a href="https://github.com/ForbesLindesay/umd#name-casing-and-characters">sanitized
and camel cased</a>.</p>

<p>Note that in standalone mode the <code class="highlighter-rouge">require()</code> calls from the original source will
still be around, which may trip up AMD loaders scanning for <code class="highlighter-rouge">require()</code> calls.
You can remove these calls with
<a href="https://www.npmjs.com/package/derequire">derequire</a>:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install -g derequire
$ browserify main.js --standalone Foo | derequire &gt; bundle.js
</code></pre></div></div>

<p><code class="highlighter-rouge">opts.insertGlobalVars</code> will be passed to
<a href="http://npmjs.org/package/insert-module-globals">insert-module-globals</a>
as the <code class="highlighter-rouge">opts.vars</code> parameter.</p>

<p><code class="highlighter-rouge">opts.externalRequireName</code> defaults to <code class="highlighter-rouge">'require'</code> in <code class="highlighter-rouge">expose</code> mode but you can
use another name.</p>
...
<p><code class="highlighter-rouge">file</code> can also be a stream, but you should also use <code class="highlighter-rouge">opts.basedir</code> so that
relative requires will be resolvable.</p>

<p>If <code class="highlighter-rouge">file</code> is an array, each item in <code class="highlighter-rouge">file</code> will be required.
In <code class="highlighter-rouge">file</code> array form, you can use a string or object for each item. Object items
should have a <code class="highlighter-rouge">file</code> property and the rest of the parameters will be used for
the <code class="highlighter-rouge">opts</code>.</p>

<p>Use the <code class="highlighter-rouge">expose</code> property of opts to specify a custom dependency name.
...
<p>Prevent <code class="highlighter-rouge">file</code> from being loaded into the current bundle, instead referencing
...
<p>If <code class="highlighter-rouge">file</code> is another bundle, that bundle’s contents will be read and excluded
...
<p>If your code tries to <code class="highlighter-rouge">require()</code> that file it will throw unless you’ve provided
another mechanism for loading it.</p>

<h2 id="btransformtr-opts">b.transform(tr, opts={})</h2>

<p>Transform source code before parsing it for <code class="highlighter-rouge">require()</code> calls with the transform
function or module name <code class="highlighter-rouge">tr</code>.</p>

<p>If <code class="highlighter-rouge">tr</code> is a function, it will be called with <code class="highlighter-rouge">tr(file)</code> and it should return a
...
<p>If <code class="highlighter-rouge">tr</code> is a string, it should be a module name or file path of a
<a href="https://github.com/substack/module-deps#transforms">transform module</a>
with a signature of:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">through</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'through'</span><span class="p">);</span>
...
<p>You don’t need to necessarily use the
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">coffee</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'coffee-script'</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">through</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'through'</span><span class="p">);</span>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify -c 'coffee -sc' main.coffee &gt; bundle.js
</code></pre></div></div>

<p>Or better still, use the <a href="https://github.com/jnordberg/coffeeify">coffeeify</a>
module:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install coffeeify
$ browserify -t coffeeify main.coffee &gt; bundle.js
</code></pre></div></div>

<p>If <code class="highlighter-rouge">opts.global</code> is <code class="highlighter-rouge">true</code>, the transform will operate on ALL files, despite
whether they exist up a level in a <code class="highlighter-rouge">node_modules/</code> directory. Use global
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ browserify -t [ foo --bar=555 ] main.js
</code></pre></div></div>

<p>or from the api:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>b.transform('foo', { bar: 555 })
</code></pre></div></div>

<p>In both cases, these options are provided as the second argument to the
transform function:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>module.exports = function (file, opts) { /* opts.bar === 555 */ }
</code></pre></div></div>

<p>Options sent to the browserify constructor are also provided under
<code class="highlighter-rouge">opts._flags</code>. These browserify options are sometimes required if your transform
needs to do something different when browserify is run in debug mode, for
example.</p>

<h2 id="bpluginplugin-opts">b.plugin(plugin, opts)</h2>

<p>Register a <code class="highlighter-rouge">plugin</code> with <code class="highlighter-rouge">opts</code>. Plugins can be a string module name or a
...
<p>You can call <code class="highlighter-rouge">b.pipeline.get()</code> with a label name to get a handle on a stream pipeline
that you can <code class="highlighter-rouge">push()</code>, <code class="highlighter-rouge">unshift()</code>, or <code class="highlighter-rouge">splice()</code> to insert your own transform
streams.</p>
...
<p>browserify uses the <code class="highlighter-rouge">package.json</code> in its module resolution algorithm, just like
node. If there is a <code class="highlighter-rouge">"main"</code> field, browserify will start resolving the package
at that point. If there is no <code class="highlighter-rouge">"main"</code> field, browserify will look for an
<code class="highlighter-rouge">"index.js"</code> file in the module root directory. Here are some more
sophisticated things you can do in the package.json:</p>

<h2 id="browser-field">browser field</h2>

<p>There is a special “<a href="https://gist.github.com/4339901">browser</a>” field you can
...
<div class="language-json highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="s2">"browser"</span><span class="p">:</span><span class="w"> </span><span class="s2">"./browser.js"</span><span class="w">
</span></code></pre></div></div>

<p>or you can have overrides on a per-file basis:</p>

<div class="language-json highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="s2">"browser"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w">
  </span><span class="s2">"fs"</span><span class="p">:</span><span class="w"> </span><span class="s2">"level-fs"</span><span class="p">,</span><span class="w">
  </span><span class="s2">"./lib/ops.js"</span><span class="p">:</span><span class="w"> </span><span class="s2">"./browser/opts.js"</span><span class="w">
</span><span class="p">}</span><span class="w">
</span></code></pre></div></div>

<p>Note that the browser field only applies to files in the local module, and like
...
<code class="highlighter-rouge">browserify.transform</code> field. There is more information about how source
...
<div class="language-json highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="s2">"browserify"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="s2">"transform"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w"> </span><span class="s2">"brfs"</span><span class="w"> </span><span class="p">]</span><span class="w"> </span><span class="p">}</span><span class="w">
</span></code></pre></div></div>

<p>to your package.json. Now when somebody <code class="highlighter-rouge">require()</code>s your module, brfs will
...
<h2 id="bpipelineonfile-function-file-id-parent-">b.pipeline.on(‘file’, function (file, id, parent) {})</h2>

<p>When a file is resolved for the bundle, the bundle emits a <code class="highlighter-rouge">'file'</code> event with
the full <code class="highlighter-rouge">file</code> path, the <code class="highlighter-rouge">id</code> string passed to <code class="highlighter-rouge">require()</code>, and the <code class="highlighter-rouge">parent</code>
object used by
<a href="https://github.com/defunctzombie/node-browser-resolve">browser-resolve</a>.</p>

<p>You could use the <code class="highlighter-rouge">file</code> event to implement a file watcher to regenerate bundles
when files change.</p>

<h2 id="bonpackage-function-pkg-">b.on(‘package’, function (pkg) {})</h2>
<h2 id="bpipelineonpackage-function-pkg-">b.pipeline.on(‘package’, function (pkg) {})</h2>
...
<p>When the <code class="highlighter-rouge">.reset()</code> method is called or implicitly called by another call to
...
<h2 id="bpipelineontransform-function-tr-file-">b.pipeline.on(‘transform’, function (tr, file) {})</h2>

<p>When a transform is applied to a file, the <code class="highlighter-rouge">'transform'</code> event fires on the
bundle stream with the transform stream <code class="highlighter-rouge">tr</code> and the <code class="highlighter-rouge">file</code> that the transform
...
<p>Plugins can be used to do perform some fancy features that transforms can’t do.
...
common bundle. Use plugins with <code class="highlighter-rouge">-p</code> and pass options to plugins with
<a href="https://www.npmjs.com/package/subarg">subarg</a> syntax:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>browserify x.js y.js -p [ factor-bundle -o bundle/x.js -o bundle/y.js ] \
  &gt; bundle/common.js
</code></pre></div></div>

<p>For a list of plugins, consult the
...
add a package.json keyword of <code class="highlighter-rouge">browserify-transform</code> so that
...
add a package.json keyword of <code class="highlighter-rouge">browserify-tool</code> so that
...
<a href="/node_modules/browserify/changelog/">changelog.markdown</a> and on the
...
<p>
  <hy-img root-margin="512px"  src="http://substack.net/images/browserify/browserify.png" alt="browserify!" >
    <noscript><img data-ignore  src="http://substack.net/images/browserify/browserify.png" alt="browserify!" /></noscript>
    <span class="loading" slot="loading" hidden>
      <span class="icon-cog"></span>
    </span>
  </hy-img></p>
